    ...
    <div>
      <div className="text-center py-4 space-y-6 my-4 bg-blue-gray-50 rounded-md">
        ...
        <p className="w-[90%] md:w-[50%] lg:w-[55%] mx-auto text-[#181D24] text-sm lg:text-base font-normal">
          We are always here to answer your questions. Reach out and we will get
          back to you as soon as possible.
        </p>
      </div>
      <div>
        <div className=" md:p-6 rounded-md flex flex-col md:flex-row justify-center">
          <div className="h-[500px] rounded">
            <img
              src={Imgs}
              className="rounded-tl-[50px] w-full h-full rounded-l"
            />
          </div>
          <div className="lg:w-1/3 h-[500px]">
            <div className="bg-gray-200 p-4 h-full rounded-br-[50px] rounded-r flex flex-col justify-center items-center text-base text-black font-medium">
